<script lang="ts">
  ...
  const TITLE = "Chimpixies";
  const DESCRTIPTION = "The 333 Chimpixies are the  next generation of DAO.";
  const HEADER_TITLE = "chimpixie.com";
  const HEADER_LINK = "Chimpixies.com";
  // Your image or GIF needs to be in the /public folder for this to work
  const IMAGE_LINK = "/ChimpixiesLogo.gif";
  /***********************************/
